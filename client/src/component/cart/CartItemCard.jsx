...
const CartItemCard = ({ product, isSearch, setSearch }) => {
    ...
    // const { updateProductQtyInCart, deleteProductFromCart, disableCart } = useCartContext();
    // const { addProductToWishlist, deleteProductFromWishlist, disableWish } = useWishlistContext();
                        ...
                        {!isSearch && (
                            <div className='flex flex-col gap-3'>
                                <div className='flex gap-2 items-center'>
                                    ...
                                    <span className='h-full w-10 bg-black/[0.075]  rounded-sm flex items-center justify-center'>{product.qty}</span>
                                    <button
                                        className='bg-[--primary-text-color] p-1 text-gray-100 rounded-md text-xs disabled:cursor-not-allowed'
                                        // disabled={disableCart}
                                        disabled={false}
