...
const CategoryCard = ({ category: { categoryName, description, categoryImg } }) => {
    ...
    return (
        ...
        >
            <img src={categoryImg} alt={categoryName} className='rounded-xl h-full w-full object-cover transition-all delay-75 ease-out' />
            <div
                className='
            ...
            >
                <h1 className='text-4xl xs:text-6xl sm:text-8xl lg:text-6xl font-extrabold text-[--theme-color] shadow-sm p-3 break-all'>{categoryName}</h1>
            </div>
        </section>
    );
};
