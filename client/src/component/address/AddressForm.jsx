...
const AddressForm = ({ setShowAddressForm, editAddress, setEditAddress }) => {
    ...
    return (
        <form action='' className='flex flex-col gap-3 p-5 bg-gray-50 shadow-sm' onSubmit={submitHandler}>
            ...
            <div className='flex gap-3 mt-3 flex-wrap'>
                ...
                <button type='submit' className='btn-rounded-primary rounded-full flex items-center gap-2 text-sm'>
                    Save
                </button>
            </div>
        </form>
